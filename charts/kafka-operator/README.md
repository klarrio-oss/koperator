...
```
kubectl create --validate=false -f https://github.com/banzaicloud/koperator/releases/download/v0.27.0/kafka-operator.crds.yaml
```
...
`operator.image.tag` | Operator container image tag | `v0.27.0`
